...
export const partnerHandlers = [
  http.get(
    `${env.VITE_BACKEND_URL}/api/v1/partner/restaurants/:restaurantId/job-posts`,
    async ({ request }) => {
  ...
  http.get(
    `${env.VITE_BACKEND_URL}/api/v1/partner/restaurants/:restaurantId/job-posts/:jobPostId`,
    async () => {
