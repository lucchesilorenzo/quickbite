...
export const riderHandlers = [
  http.get(`${env.VITE_BACKEND_URL}/api/v1/rider/job-posts`, ({ request }) => {
  ...
  http.get(`${env.VITE_BACKEND_URL}/api/v1/rider/job-posts/:jobPostId`, () => {
    return HttpResponse.json(jobPostResponse);
  }),
  http.post(
    `${env.VITE_BACKEND_URL}/api/v1/rider/job-posts/:jobPostId/applications`,
    () => {
  ...
  http.get(`${env.VITE_BACKEND_URL}/api/v1/rider/restaurant`, () => {
