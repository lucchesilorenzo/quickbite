import { CategoryWithPivot } from "@/types/categories/category.types";
...
export const category: CategoryWithPivot = {
  ...
  image_url: "/storage/category-filters/default/thai.jpg",
  is_default: true,
  ...
  pivot: {
    ...
    category_id: "0199e1dc-793e-7228-a014-9d989b34081a",
  },
};
