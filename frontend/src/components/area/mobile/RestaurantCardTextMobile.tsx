...
import RestaurantDeliveryInfo from "../content/list/restaurant-card/RestaurantDeliveryInfo";
import RestaurantMetaInfo from "../content/list/restaurant-card/RestaurantMetaInfo";
