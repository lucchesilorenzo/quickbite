...
import PartnerMenuEditAddMenuItemForm from "./PartnerMenuEditAddMenuItemForm";

type PartnerMenuEditAddMenuItemDialogProps = {
  openAddMenuItemDialog: boolean;
  setOpenAddMenuItemDialog: React.Dispatch<React.SetStateAction<boolean>>;
};

export default function PartnerMenuEditAddMenuItemDialog({
  openAddMenuItemDialog,
  setOpenAddMenuItemDialog,
}: PartnerMenuEditAddMenuItemDialogProps) {
    ...
    >
      <Stack spacing={2} sx={{ p: 2 }}>
        ...
        <DialogContent sx={{ p: 1 }}>
          <PartnerMenuEditAddMenuItemForm
