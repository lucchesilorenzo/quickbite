            ...
            case 'Starters':
                $menuItems = [
                    [
                        ...
                        'price' => 6.50,
                        'image' => 'restaurants/menu-items/default/bruschetta.jpg',
                        'is_available' => true,
                        'order' => 0,
                    ...
                    [
                        ...
                        'price' => 5.00,
                        'image' => 'restaurants/menu-items/default/garlic-bread.jpg',
                        'is_available' => true,
                        'order' => 1,
                    ],
                ];
            ...
            case 'Main Courses':
                $menuItems = [
                    [
                        ...
                        'price' => 13.90,
                        'image' => 'restaurants/menu-items/default/lasagna.jpg',
                        'is_available' => true,
                        'order' => 0,
                    ],
                    [
                        ...
                        'price' => 15.90,
                        'image' => 'restaurants/menu-items/default/grilled-chicken.jpg',
                        'is_available' => true,
                        'order' => 1,
                    ],
                    [
                        ...
                        'price' => 8.00,
                        'image' => 'restaurants/menu-items/default/pizza.jpg',
                        'is_available' => true,
                        'order' => 2,
                    ],
                ];
            ...
            case 'Drinks':
                $menuItems = [
                    [
                        ...
                        'price' => 1.50,
                        'image' => 'restaurants/menu-items/default/espresso.jpg',
                        'is_available' => true,
                        'order' => 0,
                    ],
                    [
                        ...
                        'price' => 4.50,
                        'image' => 'restaurants/menu-items/default/chianti.jpg',
                        'is_available' => true,
                        'order' => 1,
                    ],
                ];
            ...
            case 'Sides':
                $menuItems = [
                    [
                        ...
                        'price' => 4.00,
                        'image' => 'restaurants/menu-items/default/french-fries.jpg',
                        'is_available' => true,
                        'order' => 0,
                    ],
                    [
                        ...
                        'price' => 3.50,
                        'image' => 'restaurants/menu-items/default/coleslaw.jpg',
                        'is_available' => true,
                        'order' => 1,
                    ],
                ];
            ...
            case 'Salads':
                $menuItems = [
                    [
                        ...
                        'price' => 7.00,
                        'image' => 'restaurants/menu-items/default/caesar-salad.jpg',
                        'is_available' => true,
                        'order' => 0,
                    ],
                    [
                        ...
                        'price' => 7.50,
                        'image' => 'restaurants/menu-items/default/greek-salad.jpg',
                        'is_available' => true,
                        'order' => 1,
                    ],
                ];
            ...
            case 'Desserts':
                $menuItems = [
                    [
                        ...
                        'price' => 6.00,
                        'image' => 'restaurants/menu-items/default/tiramisu.jpg',
                        'is_available' => true,
                        'order' => 0,
                    ],
                    [
                        ...
                        'price' => 5.50,
                        'image' => 'restaurants/menu-items/default/panna-cotta.jpg',
                        'is_available' => true,
                        'order' => 1,
                    ],
                ];
