...
use App\Http\Controllers\Api\V1\Private\Partner\AuthController;
use App\Http\Controllers\Api\V1\Private\Partner\JobApplicationController;
use App\Http\Controllers\Api\V1\Private\Partner\JobPostController;
use App\Http\Controllers\Api\V1\Private\Partner\MenuCategoryController;
use App\Http\Controllers\Api\V1\Private\Partner\MenuController;
use App\Http\Controllers\Api\V1\Private\Partner\MenuItemController;
use App\Http\Controllers\Api\V1\Private\Partner\NotificationController;
use App\Http\Controllers\Api\V1\Private\Partner\OfferController;
use App\Http\Controllers\Api\V1\Private\Partner\OrderController;
...
Route::prefix('partner')->group(function (): void {
    ...
    Route::prefix('restaurants')
        ...
        ->group(function (): void {
            ...
            Route::get('/{restaurant}/job-posts/{jobPost}', [JobPostController::class, 'getJobPost']);
