<h1 align="center">
 <br />
   <img src="./media/quickbite-logo.png" alt="QuickBite Logo"  />
  <br />
     🍔 QuickBite
  <br />
</h1>
...
- [Customer](./media/videos/customer.mp4)
- [Partner](./media/videos/partner.mp4)
- [Rider](./media/videos/rider.mp4)
...
4. **Backend setup:**
   ...
   # Copy the Stripe webhook secret to the .env file
   ```
...
2. **Copy the .env.example file at the root to .env and update the values.**
...
5. **Copy the Stripe webhook secret to the .env file.**
